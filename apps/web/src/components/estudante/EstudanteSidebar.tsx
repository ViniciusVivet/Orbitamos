...
const navItems: NavItem[] = [
  ...
  { href: "/mensagens", label: "Mensagens", icon: "💬" },
  {
    ...
    icon: "🎓",
    children: [
      { href: "/estudante/cursos/html-css-basico", label: "Fundamentos Web", icon: "🧱" },
      { href: "/estudante/cursos/js-essencial", label: "JavaScript", icon: "⚡" },
      { href: "/estudante/cursos/react-iniciantes", label: "React", icon: "⚛️" },
    ],
  },
