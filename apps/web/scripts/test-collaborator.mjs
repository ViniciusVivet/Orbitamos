...
test("candidato nao pode alterar livremente o status",async()=>{const sql=await read("supabase/migrations/20260619001200_admin_operations_security.sql");assert.match(sql,/drop policy if exists "update own applications"/);assert.match(sql,/v3_withdraw_application/);assert.match(sql,/staff update applications/);});
