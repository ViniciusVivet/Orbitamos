...
const securityHeaders = [
  ...
  { key: "X-XSS-Protection", value: "1; mode=block" },
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' https://orbitamosbr.com https://www.orbitamosbr.com https://api.orbitamosbr.com wss://api.orbitamosbr.com https://*.supabase.co wss://*.supabase.co",
      "media-src 'self'",
...
const nextConfig: NextConfig = {
  outputFileTracingIncludes: {
    "/api/course-materials/[...path]": ["./public/course-materials/**/*"],
  },
  images: {
    remotePatterns: [
  ...
  async rewrites() {
    return [
      {
        source: "/course-materials/:path*",
        destination: "/api/course-materials/:path*",
      },
    ];
  },
};
